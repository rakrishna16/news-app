...
<div className="bg-gradient-to-r from-blue-500 to-blue-500 min-h-screen flex items-center justify-center p-4">
  ...
  <div className="flex flex-col md:flex-row">
    <div className="md:w-1/3 text-center mb-8 md:mb-0">
      ...
      <h2 className="rounded-full p-5 mb-3 text-lg font-extrabold text-center w-32 h-32 mx-auto border-4 border-indigo-800 dark:border-blue-900 transition-transform duration-300 hover:scale-105" >HK</h2>
